...
class LeafNode(object):
    ...
    def predict(self, x_TF):
        ...
        '''
        T = x_TF.shape[0]
        # Return array where all examples get the mean of training labels
        yhat_T = np.mean(self.y_N) * np.ones(T, dtype=np.float64)
        return yhat_T
