# Generative AI & Image Colorization Models

This repository contains deep learning computer vision implementations, specifically focusing on CNNs for image colorization and Variational Autoencoders for image generation.

## 1. Image Colorization CNN - Architectural Analysis
...
- BatchNorm and biases are **ignored**.  
- padding = K//2, stride=2 for pooling/upsampling.

---

## 2. Beta-VAE Image Generation

Implementation of a $\beta$-Variational Autoencoder to generate images, exploring the interpretability-fidelity trade-off within the latent space.
